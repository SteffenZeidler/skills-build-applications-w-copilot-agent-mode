...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        users = [
            ...
            User(_id=ObjectId(), email='crashoverride@hmhigh.edu', name='Natasha Romanoff', password='crashoverridepassword'),
        ...
        # Create activities
        activities = [
            Activity(_id=ObjectId(), user=users[0], type='Cycling', duration=60, date='2025-04-25'),
            Activity(_id=ObjectId(), user=users[1], type='Crossfit', duration=120, date='2025-04-24'),
            Activity(_id=ObjectId(), user=users[2], type='Running', duration=90, date='2025-04-23'),
            Activity(_id=ObjectId(), user=users[3], type='Strength', duration=30, date='2025-04-22'),
            Activity(_id=ObjectId(), user=users[4], type='Swimming', duration=75, date='2025-04-21'),
        ]
